  ...
  <body class="app sidebar-mini">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                          <input id="nim" name="nim" class="form-control" type="text" placeholder="NIM" disabled>
                        </div>
                        <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        $( document ).ready(function() {
            $.get("/pembayaran-ukt/ukt/<?= $_GET['nim'] ?>", function(data, status){
                $("#nim").val(data.nim);
                $("#nama").val(data.nama);
                $("#prodi").val(data.prodi);
                $("#fakultas").val(data.fakultas);
                $("#nominal_ukt").val(data.nominal_ukt);
